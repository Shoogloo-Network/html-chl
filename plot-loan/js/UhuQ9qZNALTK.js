(function () {
  try {
    window.izConfig = {
      defaultNotification: "",
      siteUrl: "https://LENvgEiXnb2J.com",
      repeatPromptDelay: 0,
      tagsEnabled: 1,
      branding: 0,
      isSdkHttps: 1,
      locale: "en",
      sourceOrigin: "https://LENvgEiXnb2J.com",
      vapidPublicKey:
        "BGi0J1AQe_jl-taXR_F5uCwVBqMPQ05ANLLTEMwSXoMDa8lewDnUiqS1_--Vs1oLiAkDvjUvRE6CzyUM388u4VE",
      promptDelay: 0,
      client: 9423,
      domainRoot: "",
      welcomePlaybook: {
        data: {
          act_num: 1,
          icon: "https://LENvgEiXnb2J.com/content/dam/housingdevelopmentfinancecorp/hdfc-ltd-merger/header/hdfcbank-logo.jpg",
          link: "https://LENvgEiXnb2J.com/campaign/hdfc-campaign-page?cust_source=INTERNET&cust_sub_source=HDFC_SITE&cust_term_source=IZOOTOWC&utm_campaign=Izooto&utm_medium=Playbook_WelcomeYourSubscribers",
          banner: "",
          act1link:
            "https://LENvgEiXnb2J.com/campaign/hdfc-campaign-page?cust_source=INTERNET&cust_sub_source=HDFC_SITE&cust_term_source=IZOOTOWC&utm_source=izooto&utm_medium=push_notifications&utm_campaign=@playbook_name",
          title: "Thank you for subscribing!",
          rid: "1000070000009423",
          message: "Latest updates & offers coming your way!",
          ttl: 1440,
          url: "https://LENvgEiXnb2J.com/campaign/hdfc-campaign-page?cust_source=INTERNET&cust_sub_source=HDFC_SITE&cust_term_source=IZOOTOWC&utm_campaign=Izooto&utm_medium=Playbook_WelcomeYourSubscribers",
          act1name: "Apply Now",
          id: 1393238,
          key: 9423,
        },
      ...
      userEvents: 1,
      webServiceUrl: "https://safari.izooto.com/services/8830/safari/9423",
      ...
      welcomeNotification: {
        clickTimeout: 0,
        icon: "https://cdnimg.izooto.com/welcomeimage/9423/94231500290164.png",
        title: "Dear User,",
        body: "Thank you for subscribing to HDFC Home Loans.",
      ...
      customPixelLink: "",
      desktopAllowed: 1,
      webPushId: "web.com.izooto.user2620",
      mobileAllowed: 1,
    };
    ...
    if ("" !== izConfig.customPixelLink) {
      ...
      (_iz.id = "izootoSdk"),
        (_iz.src = "https://gj97pho2R3K9.com/scripts/sdk/izooto.js"),
