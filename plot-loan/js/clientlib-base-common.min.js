      ...
      7293: function () {
        !(function (e) {
          ...
          function (e, t, n) {
            ...
            let l = 0;
            const m = (e) =>
                "mm-clone-" == e.slice(0, 9) ? e : "mm-clone-" + e,
            ...
            const p = (e) => {
              ...
              u = (e, t) =>
                t.length ? [].slice.call(e.querySelectorAll(t)) : [],
              f = (e, t) => {
              ...
              v = (e) => e.filter((e) => !e.matches(".mm-hidden")),
              g = (e) => {
                let t = [];
                return (
                  v(e).forEach((e) => {
                    t.push(...f(e, "a.mm-listitem__text"));
                  }),
            ...
            const w = (e, t, n) => {
              ...
              E = (e, t) => {
                ...
                for (let t = 0; t < _[e].length; t++) _[e][t][n]();
              };
            var y,
              P,
              S,
            ...
            class k {
              ...
              openPanel(e, t = !0, n = !0) {
                ...
                if (s) {
                  ...
                  const n = f(this.node.pnls, ".mm-panel--opened")[0];
                  ...
                  const s = ["mm-panel--opened", "mm-panel--parent"],
                    i = [];
                  t
                    ? s.push("mm-panel--noanimation")
                    : i.push("mm-panel--noanimation"),
                    f(this.node.pnls, ".mm-panel").forEach((t) => {
                      t.classList.add(...i),
                  ...
                  let a = u(this.node.pnls, "#" + e.dataset.mmParent)[0];
                  for (; a; )
                    (a = a.closest(".mm-panel")),
                      a.classList.add("mm-panel--parent"),
                      (a = u(this.node.pnls, "#" + a.dataset.mmParent)[0]);
                }
              ...
              closePanel(e, t = !0, n = !0) {
                if (
                  ...
                  if (
                    ...
                    const s = u(this.node.pnls, "#" + e.dataset.mmParent)[0];
                    this.openPanel(s, t, n);
                  } else {
                    const s = f(this.node.pnls, ".mm-panel--parent").pop();
                    if (s && s !== e) this.openPanel(s, t, n);
                    else {
                      const s = f(this.node.pnls, ".mm-panel")[0];
              ...
              setSelected(e) {
                this.trigger("setSelected:before", [e]),
                  u(this.node.menu, ".mm-listitem--selected").forEach((e) => {
              ...
              _initMenu() {
                ...
                const e = f(this.node.menu).filter((e) =>
                  e.matches(this.conf.panelNodetype.join(", "))
                );
                (this.node.pnls = p("div.mm-panels")),
              ...
              _initPanel(e) {
                ...
                if (
                  !e.matches(".mm-panel") &&
                  (L(e, this.conf.classNames.panel, "mm-panel"),
                  L(e, this.conf.classNames.nopanel, "mm-nopanel"),
                  ...
                  return (
                    ...
                    x(this, y).observe(e, { childList: !0 }),
              ...
              _initNavbar(e) {
                if (f(e, ".mm-navbar").length) return;
                let t = null,
                  n = null;
                if (e.dataset.mmParent)
                  for (
                    t = u(this.node.pnls, "#" + e.dataset.mmParent)[0],
                ...
                const s = p("div.mm-navbar");
                if ((this.opts.navbar.add || s.classList.add("mm-hidden"), n)) {
                  const e = p("a.mm-btn.mm-btn--prev.mm-navbar__btn");
                  (e.href = "#" + n.id),
                    e.setAttribute(
                      "aria-label",
                ...
                let i = null;
                t
                  ? (i = f(t, ".mm-listitem__text")[0])
                  : n && (i = u(n, 'a[href="#' + e.id + '"]')[0]);
                const a = p("a.mm-navbar__title");
                switch (
                  ((a.tabIndex = -1),
              ...
              _initListview(e) {
                ["htmlulistelement", "htmlolistelement"].includes(o(e)) &&
                  (e.matches(".mm-listview") ||
                    (L(e, this.conf.classNames.nolistview, "mm-nolistview"),
                    e.matches(".mm-nolistview") ||
                      ...
                      x(this, P).observe(e, { childList: !0 }),
                      this.trigger("initListview:after", [e]))));
              }
              _initListitem(e) {
                ["htmllielement"].includes(o(e)) &&
                  (e.matches(".mm-listitem") ||
                    (L(e, this.conf.classNames.divider, "mm-divider"),
                    e.matches(".mm-divider") ||
                      ...
                      f(e, "a, span").forEach((e) => {
                        e.classList.add("mm-listitem__text");
                      }),
                      f(e, this.conf.panelNodetype.join(", ")).forEach((e) => {
                        this._initSubPanel(e);
                      }),
                      x(this, S).observe(e, { childList: !0 }),
              ...
              _initSubPanel(e) {
                ...
                let n = f(t, ".mm-btn")[0];
                n ||
                  ((n = p("a.mm-btn.mm-btn--next.mm-listitem__btn")),
                  f(t, "a, span").forEach((e) => {
                    e.matches("span")
              ...
              _initOpened() {
                ...
                const e = u(this.node.pnls, ".mm-listitem--selected").pop();
                let t = f(this.node.pnls, ".mm-panel")[0];
            ...
            (k.prototype.open = function () {
              this.node.menu.matches(".mm-menu--opened") ||
                ...
                k.node.blck.removeAttribute("inert"),
                k.node.page.setAttribute("inert", "true"),
              ...
              (k.prototype.close = function () {
                ...
                this.node.menu.matches(".mm-menu--opened") &&
                  ...
                  k.node.blck.setAttribute("inert", "true"),
                  k.node.page.removeAttribute("inert"),
                  null ===
                    (e =
                      this.node.open ||
                      document.querySelector(
                        `[href="#${this.node.menu.id}"]`
                      ) ||
                      null) ||
                    void 0 === e ||
                    e.focus(),
              ...
              (k.prototype.setPage = function (e) {
                ...
                if (!e) {
                  let n =
                    "string" == typeof t.page.selector
                      ? u(document.body, t.page.selector)
                      : f(document.body, t.page.nodetype);
                  if (
                    ((n = n.filter(
                    ...
                    t.page.noSelector.length &&
                      (n = n.filter(
                        (e) => !e.matches(t.page.noSelector.join(", "))
                      )),
                    n.length > 1)
                  ) {
                    let e = p("div");
                ...
                this.trigger("setPage:before", [e]),
                  ...
                  (e.id = e.id || r()),
                  k.node.blck.setAttribute("href", "#" + e.id),
                  (k.node.page = e),
                  this.trigger("setPage:after", [e]);
              });
            var N = { fix: !0 };
            const O =
                "ontouchstart" in window || !!navigator.msMaxTouchPoints || !1,
              j = [
                "light",
                "dark",
                "white",
            ...
            k.prototype.theme = function (e = null) {
            ...
            var H = { close: !1, open: !1 },
              ...
              B = { add: !1, blockPanel: !0, visible: 3 },
              R = { breadcrumbs: { separator: "/", removeFirst: !1 } };
            function D() {
              (this.opts.navbars = this.opts.navbars || []),
                (this.conf.navbars = this.conf.navbars || {}),
                a(this.conf.navbars, R);
              ...
              if (void 0 !== e && (e instanceof Array || (e = [e]), e.length)) {
                ...
                e.forEach((e) => {
                  if (
                    ...
                    return;
                  const n = p("div.mm-navbar");
                  let { position: s } = e;
                  "bottom" !== s && (s = "top"),
                    t[s] || (t[s] = p("div.mm-navbars.mm-navbars--" + s)),
                    t[s].append(n);
                  for (let t = 0, s = e.content.length; t < s; t++) {
                    const s = e.content[t];
                    if ("string" == typeof s) {
                      const e = D.navbarContents[s];
            ...
            (D.navbarContents = {
              breadcrumbs: function (e) {
                var t = p("div.mm-navbar__breadcrumbs");
                e.append(t),
                  this.bind("initNavbar:after", (e) => {
                    if (!e.querySelector(".mm-navbar__breadcrumbs")) {
                      ...
                      for (
                        var t = [],
                          n = p("span.mm-navbar__breadcrumbs"),
                          s = e,
                          i = !0;
                        s;
                        ...
                        if (
                          ...
                          let e = u(s, ".mm-navbar__title span")[0];
                          if (e) {
                            let n = e.textContent;
                            n.length &&
                              t.unshift(
                        ...
                        s = u(this.node.pnls, "#" + s.dataset.mmParent)[0];
                      }
              ...
              close: function (e) {
                const t = p("a.mm-btn.mm-btn--close.mm-navbar__btn");
                t.setAttribute(
                  "aria-label",
              ...
              searchfield: function (e) {
                let t = p("div.mm-navbar__searchfield");
                (t.id = r()),
                  e.append(t),
              ...
              (D.navbarTypes = {
                tabs: function (e) {
                  function t(n) {
                    const s = f(e, `.mm-navbar__tab[href="#${n.id}"]`)[0];
                    if (s)
                      s.classList.add("mm-navbar__tab--selected"),
                        (s.ariaExpanded = "true");
                    else {
                      const e = u(this.node.pnls, "#" + n.dataset.mmParent)[0];
                  ...
                  e.classList.add("mm-navbar--tabs"),
                    e
                      .closest(".mm-navbars")
                      .classList.add("mm-navbars--has-tabs"),
                    f(e, "a").forEach((e) => {
                          ...
                          const i =
                            null ===
                              (n =
                                null === (t = e.target) || void 0 === t
                                  ? void 0
                                  : t.closest(".mm-navbar__tab")) ||
                            void 0 === n
                              ? void 0
                              : n.getAttribute("href");
                          try {
                            null ===
                              (s = u(this.node.pnls, i + ".mm-panel")[0]) ||
                              void 0 === s ||
            ...
            var $ = { scroll: !1, update: !1 },
              F = { scrollOffset: 0, updateOffset: 50 },
              Z = {
                add: !1,
                addTo: "panels",
            ...
            const z = function () {
                ...
                let n = f(this.node.pnls, ".mm-panel--search")[0];
                return (
                  n ||
                  ((n = p("div.mm-panel--search")),
                  Q(n, t.panel),
              ...
              V = function (e) {
                ...
                if (
                  ...
                  !u(e, ".mm-panel__splash").length
                ) {
                  const n = p("div.mm-panel__splash");
                  (n.innerHTML = t.splash), e.append(n);
                }
                if (
                  t.noResults.length &&
                  !u(e, ".mm-panel__noresults").length
                ) {
                  const n = p("div.mm-panel__noresults");
              ...
              U = function (e = !1) {
                const t = this.opts.searchfield,
                  ...
                  s = p("form.mm-searchfield");
                Q(s, n.form);
                const i = p("div.mm-searchfield__input");
                s.append(i);
                const a = p("input");
                if (
                  (i.append(a),
                ...
                if (n.cancel && e) {
                  const e = p("a.mm-searchfield__cancel");
                  (e.href = "#"),
                    ...
                    e.addEventListener("click", (e) => {
                      e.preventDefault(),
                        this.closePanel(
                          f(this.node.pnls, ".mm-panel--search")[0],
                          !1
                        );
                    });
                }
              ...
              Y = function (e) {
                const t = this.opts.searchfield,
                  n =
                    e.closest(".mm-panel") ||
                    u(this.node.pnls, ".mm-panel--search")[0],
                  s = u(e, "input")[0];
                let i = n.matches(".mm-panel--search")
                  ? f(this.node.pnls, t.searchIn)
                  : [n];
                ...
                const a = () => {
                  ...
                  if (
                    (i.forEach((e) => {
                      (e.scrollTop = 0), o.push(...u(e, ".mm-listitem"));
                    }),
                    a.length)
                  ) {
                    this.trigger("search:before"),
                      ...
                      o.forEach((e) => {
                        const t = f(e, ".mm-listitem__text")[0];
                        var n;
                        (!t ||
                          ((n = t),
                          [].slice
                    ...
                    let e = 0;
                    (e = n.matches(".mm-panel--search") ? G(n, a, i) : X(a, i)),
                      n.classList[0 == e ? "add" : "remove"](
                        "mm-panel--noresults"
                      ),
                    ...
                    this.trigger("clear:before"),
                      ...
                      n.matches(".mm-panel--search")
                        ? (K(n), t.splash || this.closePanel(n, !1, !1))
                        : J(i),
              ...
              G = (e, t, n) => {
                const s = u(e, ".mm-listview")[0];
                s.innerHTML = "";
                let i = 0;
                return (
                  n.forEach((e) => {
                    const n = u(e, `[data-mm-searchresult="${t}"]`);
                    if (((i += n.length), n.length)) {
                      const t = u(e, ".mm-navbar__title")[0];
                      if (t) {
                        const e = p("li.mm-divider");
                  ...
                  u(s, ".mm-listitem--opened").forEach((e) => {
              ...
              K = (e) => {
                u(e, ".mm-listview")[0].innerHTML = "";
              },
              X = (e, t) => {
                let n = 0;
                return (
                  t.forEach((t) => {
                    const s = u(t, `[data-mm-searchresult="${e}"]`);
                    (n += s.length),
                      s.length &&
                        s.forEach((t) => {
                          const n = ((e, t) => {
                      ...
                      u(t, ".mm-listitem, .mm-divider").forEach((t) => {
                        t.classList.add("mm-hidden"),
              ...
              J = (e) => {
                e.forEach((e) => {
                  u(e, ".mm-listitem, .mm-divider").forEach((e) => {
                    e.classList.remove("mm-hidden");
                  });
                });
              },
            ...
            var ee = { add: !1, addTo: "panels" },
              te = { current: !0, hover: !1, parent: !1 },
              ne = {
                collapsed: { use: !1 },
            ...
            (k.addons = {
              offcanvas: function () {
                ...
                const e = a(this.opts.offCanvas, T),
                  t = a(this.conf.offCanvas, A);
                e.use &&
                  (C.includes(e.position) || (e.position = C[0]),
                  this._api.push("open", "close", "setPage", "position"),
                  this.bind("initMenu:before", () => {
                    t.clone &&
                      ((this.node.menu = this.node.menu.cloneNode(!0)),
                      this.node.menu.id &&
                        (this.node.menu.id = m(this.node.menu.id)),
                      u(this.node.menu, "[id]").forEach((e) => {
                        e.id = m(e.id);
                      })),
                      (this.node.wrpr = document.querySelector(
                        t.menu.insertSelector
                      )),
              ...
              scrollBugFix: function () {
                ...
                if (
                  ...
                  !a(this.opts.scrollBugFix, N).fix)
                )
                  return;
                const e = ((e) => {
                  let t = "",
                ...
                this.node.menu.addEventListener(
                  ...
                  this.bind("open:after", () => {
                    var e = f(this.node.pnls, ".mm-panel--opened")[0];
                    e && (e.scrollTop = 0);
                  }),
                  window.addEventListener("orientationchange", (e) => {
                    var t = f(this.node.pnls, ".mm-panel--opened")[0];
                    t &&
                      ((t.scrollTop = 0),
              ...
              theme: function () {
                ...
                j.includes(e) || (this.opts.theme = j[0]),
              ...
              backButton: function () {
                if (
                  ...
                  return;
                const e = a(this.opts.backButton, H),
                  t = "#" + this.node.menu.id;
                if (e.close) {
                  var n = [];
                  const e = () => {
              ...
              counters: function () {
                if (
                  ...
                  !a(this.opts.counters, q).add)
                )
                  return;
                const e = (e) => {
                    const t = this.node.pnls.querySelector(
                      "#" + e.dataset.mmParent
                    );
                    if (!t) return;
                    ...
                    if (!n) return;
                    const s = [];
                    f(e, ".mm-listview").forEach((e) => {
                      s.push(...f(e, ".mm-listitem"));
                    }),
                      (n.innerHTML = v(s).length.toString());
                  },
                  t = new MutationObserver((t) => {
                    t.forEach((t) => {
                      "class" == t.attributeName &&
                        e(t.target.closest(".mm-panel"));
                    });
                  });
                this.bind("initListview:after", (t) => {
                  ...
                  if (!s) return;
                  const i = f(s, ".mm-btn")[0];
                  if (i) {
                    if (!f(i, ".mm-counter").length) {
                      const e = p("span.mm-counter");
              ...
              iconbar: function () {
                ...
                if (
                  (["top", "bottom"].forEach((n, s) => {
                    let i = e[n];
                    "array" != o(i) && (i = [i]);
                    const a = p("div.mm-iconbar__" + n);
                    for (let e = 0, t = i.length; e < t; e++)
                      "string" == typeof i[e]
                        ? (a.innerHTML += i[e])
                        : a.append(i[e]);
                    a.children.length &&
                      (t || (t = p("div.mm-iconbar")), t.append(a));
                  }),
                  t)
                ) {
                  this.bind("initMenu:after", () => {
              ...
              iconPanels: function () {
                ...
                const e = a(this.opts.iconPanels, B);
                let t = !1;
                if (
              ...
              pageScroll: function () {
                ...
                const e = a(this.opts.pageScroll, $),
                  t = a(this.conf.pageScroll, F);
                var n;
                function s() {
                  n &&
                    window.scrollTo({
                ...
                function i(e) {
                  try {
                    if ("#" == e.slice(0, 1)) return u(k.node.page, e)[0];
                  } catch (e) {}
                  return null;
                }
                if (
                    ...
                    (s) => {
                      ...
                      for (var a = 0; a < e.length; a++)
                        if (e[a].offsetTop < i + t.updateOffset) {
                          if (n !== a) {
                            n = a;
                            let t = f(this.node.pnls, ".mm-panel--opened")[0],
                              s = u(t, ".mm-listitem"),
                              i = g(s);
                            (i = i.filter((t) =>
              ...
              searchfield: function () {
                ...
                if ((a(this.conf.searchfield, W), e.add)) {
                  switch (e.addTo) {
                    case "panels":
                      e.addTo = ".mm-panel";
                      break;
                  ...
                  this.bind("initPanel:after", (t) => {
                    ...
                    this.bind("initMenu:after", () => {
                      const t = z.call(this);
                      V.call(this, t),
                        u(this.node.menu, e.addTo).forEach((n) => {
                          if (!n.matches(".mm-panel")) {
                            const s = U.call(this, !0);
                            n.append(s);
                            const i = u(s, "input")[0];
                            e.splash.length
                    ...
                    this.bind("close:before", () => {
                      u(this.node.menu, ".mm-searchfield input").forEach(
                        (e) => {
                          e.blur();
                        }
                      );
              ...
              sectionIndexer: function () {
                (this.opts.sectionIndexer = this.opts.sectionIndexer || {}),
                  a(this.opts.sectionIndexer, ee).add &&
                    this.bind("initPanels:after", () => {
                      if (!this.node.indx) {
                        let e = "";
                        ...
                        let n = (e) => {
                          ...
                          const t = e.target.textContent,
                            n = f(this.node.pnls, ".mm-panel--opened")[0];
                          let s = -1,
                            i = n.scrollTop;
                          (n.scrollTop = 0),
                            u(n, ".mm-divider")
              ...
              setSelected: function () {
                ...
                const e = a(this.opts.setSelected, te);
                if ("detect" == e.current) {
                  const e = (t) => {
                    t = t.split("?")[0].split("#")[0];
                  ...
                  e.current ||
                    this.bind("initListview:after", (e) => {
                      f(e, ".mm-listitem--selected").forEach((e) => {
                        e.classList.remove("mm-listitem--selected");
                      });
                    });
                e.hover &&
                  ...
                  e.parent &&
                    (this.bind("openPanel:after", (e) => {
                      ...
                      let t = e;
                      for (; t; ) {
                        let e = u(this.node.pnls, "#" + t.dataset.mmParent)[0];
              ...
              sidebar: function () {
                ...
                const e = a(this.opts.sidebar, ne);
                if (e.collapsed.use) {
                  this.bind("initMenu:after", () => {
  ...
  var e = {
      9342: function () {
        document.addEventListener("DOMContentLoaded", function () {
          var e,
            t = document.querySelectorAll(".primary-menu-link.dd"),
            n = document.querySelector(".header-backdrop"),
            ...
            a = 0;
          function c(e, t, n) {
            n && n.classList.remove("backdrop-hidden"),
              e.classList.add("pm-hover"),
              t.classList.remove("hidden");
          }
          function s(e, t, n) {
            n && n.classList.add("backdrop-hidden"),
              e.classList.remove("pm-hover"),
              t.classList.add("hidden");
          }
          document.addEventListener("click", function (e) {
            !r ||
              e.target.closest(".primary-menu-link.dd") ||
              e.target.closest(".adjust-wrap") ||
              ((r = !1),
            ...
            o.forEach(function (t) {
              var i = document.getElementById(t),
                d = document.getElementById(t + "-panel");
              i.addEventListener("mouseover", function () {
                ...
                i.addEventListener("mouseout", function () {
                  var t = o.filter(function (e) {
                    return document
                      .getElementById(e)
                      .classList.contains("pm-hover");
                  });
                  (r && t.length <= 1) ||
                    (clearInterval(e), (a = 0), s(i, d, n));
                }),
                d
                  .querySelector(".adjust-wrap")
                ...
                d
                  ...
                  .addEventListener("mouseout", function () {
                    ...
                    (r && e.length <= 1) || s(i, d, n);
                  });
            });
          var i = document.querySelector(".navbar-sticky-top"),
            d = document.querySelector(".secondary-navbar").offsetHeight,
            l = document.querySelector(".primary-navbar").offsetHeight,
            u = document.querySelector(
              ".container.responsivegrid:not(.form-page-wrap) > .cmp-container > .container.responsivegrid.img-container"
            );
          document.addEventListener("scroll", function (e) {
            window.innerWidth > 991 &&
              (window.scrollY > 180
                ? ((i.style.top = -d + "px"),
                  u && (u.style.top = l + "px"),
                  (i.style.boxShadow = "0 3px 9px 0 rgb(0 0 0 / 16%)"))
                : ((i.style.top = "0px"),
                  u && (u.style.top = "unset"),
                  (i.style.boxShadow = "none")));
          });
          var m = document.getElementById("ec-link"),
            v = document.getElementById("ec-menu");
      ...
      1225: function () {
        document.addEventListener("DOMContentLoaded", function () {
          var e = document.getElementById("info-strip"),
            t = document.querySelector("#info-strip a"),
            n = sessionStorage.getItem("strip"),
            o = !1;
          t &&
            t.addEventListener("click", function (t) {
              t.preventDefault(),
                e && e.closest(".info-strip").classList.remove("active"),
                sessionStorage.setItem("strip", "true");
            }),
            document.addEventListener("scroll", function () {
              scrollY > 200 &&
                !o &&
                (!n && e && e.closest(".info-strip").classList.add("active"),
                (o = !0));
            });
        });
      },
      6362: function () {
        document.addEventListener("DOMContentLoaded", function () {
          var e = document.querySelector(".image.header-logo .cmp-image__link");
          e && e.setAttribute("href", e.getAttribute("href") + "/");
        });
      },
      650: function () {
        document.addEventListener("DOMContentLoaded", function (e) {
          if (window.innerWidth < 992) {
            var t,
              n = document.querySelector(".mn-hamburger-btn"),
              o = document.querySelector(".mn-ec-menu-open"),
              r = document.querySelector("#mn-ec-link"),
              a = document.querySelector(".mn.ec-pop-up-div"),
              c = document.querySelector(".mn.close-ec-btn"),
              s = document.querySelectorAll(".mn-primary-menu-link.dd"),
              i = document.querySelector(".region-select #langSelect"),
              d = i && i.querySelectorAll("option"),
              l = "",
              u = !1,
              m = document.querySelector(".image.header-logo > .cmp-image"),
              v = document.querySelector(
                ".image-text.header-logo > .cmp-image-text a .cmp-image__image_text"
              )
                ? document
                    .querySelector(
                      ".image-text.header-logo > .cmp-image-text a .cmp-image__image_text"
                    ...
                    .getAttribute("src")
                : "";
            m && m.dataset.asset ? (t = m.dataset.asset) : v && (t = v),
                ...
                navbars: [
                  {
                    position: "top",
                    content: [
                      '<div class="mn-menu-header"><div class="mn-secondary-navbar"><div class="call-us-div"><a href="tel:9289200017" class="call-us-text">+91-9289200017 - Give a Missed Call</a></div></div><div class="mn-header-wrap"><div class="mn-logo-select-wrap"><a href="/content/housingdevelopmentfinancecorp/in/en.html"><img class="mn-menu-hdfc-logo" src="' +
                        t +
                        '" alt="HDFC Bank Logo"></a><div class="secondary-menu-select-wrap"><select name="language-options" id="langSelect">' +
                        l +
                        '</select></div></div><a class="mn close-hamburger-btn" href="javascript: void(0)"><img class="mn close-hamburger-icon" src="/content/dam/housingdevelopmentfinancecorp/hdfc-ltd-merger/header/menu/close.svg" alt="Close Icon"></a></div></div>',
                    ],
                  },
                ],
              },
            ...
            document
              .querySelector(".mn.close-hamburger-btn")
              .addEventListener("click", function () {
                var e = document.querySelector(".mm-panel--opened");
                e && f.closePanel(e), f.close();
              }),
              ...
              c.addEventListener("click", function () {
                u
                  ? (f.open(), (a.style.transform = "translateX(-100%)"))
                  : (a.style.transform = "translateX(-100%)"),
                  (document.body.style.overflow = "unset");
              }),
              Array.from(s).forEach(function (e) {
                var t = e.nextElementSibling.getAttribute("href");
                e.href = t;
              });
          }
        });
...
!(function () {
  var n = {
      4055: function () {
        $(function () {
          $(".boldHead").on("click", function () {
            window.innerWidth < 992 &&
              ($(this).children(".accordianShow").slideToggle(),
              $(this)
                .children(".accordianShow")
                .parents(".wrapLists")
                .siblings()
                .find(".accordianShow")
                .slideUp(),
...
!(function () {
  ...
  if (
    ...
    var o = document
      .getElementById("page-subcategory")
      .value.replace(/ /g, "_")
      .toLowerCase();
  if (
    null !== document.querySelector(".region-select .cmp-form-options__field")
  )
    var l = document.querySelector(
      ".region-select .cmp-form-options__field"
    ).value;
  else var l = "english";
  if (null !== document.querySelector(".label-none .cmp-form-options__field"))
    l = document.querySelector(".label-none .cmp-form-options__field").value;
  else l = "english";
  window.addEventListener("load", function () {
    t.pgloadtime =
      window.performance.timing.domComplete -
      window.performance.timing.navigationStart;
    var e = $(".contact-datalayer .cmp-form"),
      a = $(".cmp-form").attr("id");
    if (
      (location.href.includes("/service-request") &&
        (a = "service_request_form"),
      e.length > 0)
    )
      window.adobeDataLayer.push({
        event: "landed",
        ...
        pageInfo: {
          ...
          pageCategory: i,
          pageSubCategory: o,
          pageLoadTime: t.pgloadtime,
          language: l,
        },
        formInfo: { formName: a },
      }),
        localStorage.setItem("formname", JSON.stringify(a));
    else if (localStorage.thankyouload) {
      var r = JSON.parse(localStorage.getItem("thankyouload"));
      window.adobeDataLayer.push({
        event: "thankyouload",
        eventInfo: { eventName: "thankyouload" },
        pageInfo: {
          pageName: n,
          pageCategory: JSON.parse(localStorage.pagesubcategory),
          pageSubCategory: o,
          pageLoadTime: t.pgloadtime,
          language: JSON.parse(localStorage.language),
        },
        formInfo: r.formInfo,
        userInfo: r.userInfo,
      }),
        localStorage.removeItem("thankyouload"),
    ...
    $(function () {
      $(".header-logo a").on("click", function () {
        ...
        a("click", n, i, o, l, {
          linkInfo: {
            linkName: "logo",
            linkType: "link",
            linkPosition: "top_menu_link",
            linkhref: e || "",
          },
        });
      }),
        $(".faqs-btn a").off("click"),
        $(
          ".primary-menu-link, .search-icon a, .ec-menu-btn-wrap a, .ec-menu-item a, .mn-primary-menu-link, .mn-sub-menu-item .mm-listitem__text, .secondary-menu-item a, .faqs-btn a, .mn-secondary-menu-item a"
        ).on("click", function () {
          let e = $(this).text().trim().replace(/ /g, "_").toLowerCase();
        ...
        $(".hover-nav-link").on("click", function () {
          let e = $(this)
            .children("span")
            .text()
            .trim()
          ...
          a("click", n, i, o, l, {
            linkInfo: {
              linkName: e,
              linkType: "link",
              linkPosition: "top_navigation_menu",
              linkhref: t || "",
            },
          });
        }),
        $(".hover-sub-item a").on("click", function () {
          let e = $(this).text().trim().replace(/ /g, "_").toLowerCase();
          var t = $(this).attr("href");
          a("click", n, i, o, l, {
            linkInfo: {
        ...
        $(".teaser-cf-wrap .teaser-content-wrap a").on("click", function () {
          let e = $(this).text().trim().replace(/ /g, "_").toLowerCase();
          var t =
              "top_navigation_menu:" +
              $(this)
                .parents(".teaser-content-wrap")
      ...
      var e = document.querySelectorAll("#langSelect"),
        t = document.getElementById("lang-enabled");
      if (!t) {
        var r = document.querySelector(".options.region-select"),
          c = document.querySelector(".secondary-menu-select-wrap");
        r && (r.style.display = "none"), c && (c.style.display = "none");
      }
      e.length > 0 &&
        t &&
        e.forEach(function (e) {
          try {
            location.pathname &&
              (location.pathname.includes("/hindi")
                ? (e.querySelector('[value="/hindi/"]').selected = !0)
                : location.pathname.includes("/marathi")
                ? (e.querySelector('[value="/marathi/"]').selected = !0)
                : location.pathname.includes("/tamil")
                ? (e.querySelector('[value="/tamil/"]').selected = !0)
                : location.pathname.includes("/telugu")
                ? (e.querySelector('[value="/telugu/"]').selected = !0)
                : location.pathname.includes("/kannada")
                ? (e.querySelector('[value="/kannada/"]').selected = !0)
                : location.pathname.includes("/malayalam")
                ? (e.querySelector('[value="/malayalam/"]').selected = !0)
                : (e.querySelector('[value="/"]').selected = !0));
          } catch (e) {}
          e.addEventListener("change", function (e) {
            ...
            a("click", n, i, o, l, {
              linkInfo: {
                linkName: t,
                linkType: "link",
                linkPosition: "language_switcher:",
                linkhref: "",
              },
            });
            var r,
              c = $(this).val();
            location.pathname &&
              (r = location.pathname.includes("/hindi")
                ? location.pathname.replace("/hindi/", c)
                : location.pathname.includes("/marathi")
                ? location.pathname.replace("/marathi/", c)
                : location.pathname.includes("/tamil")
                ? location.pathname.replace("/tamil/", c)
                : location.pathname.includes("/telugu")
                ? location.pathname.replace("/telugu/", c)
                : location.pathname.includes("/kannada")
                ? location.pathname.replace("/kannada/", c)
                : location.pathname.includes("/malayalam")
                ? location.pathname.replace("/malayalam/", c)
                : location.pathname.replace("/", c)),
              (window.location.href = r);
          });
        }),
        $(
          "#block-floatingmenu .animate-li a, #block-floatingmenu .no-animate a, #block-floatingmenu .float-mobile a"
        ).off("click"),
        $(
          "#block-floatingmenu .animate-li a, #block-floatingmenu .no-animate a, #block-floatingmenu .float-mobile a"
        ).on("click", function () {
          if ("Instant Call Back" != $(this).attr("title")) {
            let t = $(this).text().trim().replace(/ /g, "_").toLowerCase(),
              r = "link";
            var e = $(this).attr("href");
            a("click", n, i, o, l, {
              linkInfo: {
            ...
            !(function (e) {
              ...
              var m = { formInfo: { formName: c, formId: s } };
              localStorage.setItem("formInfo", JSON.stringify(m.formInfo)),
                setTimeout(() => {
                  a("formload", n + ":" + c, c, o + ":" + c, l, m);
                }, 1e3);
            })($(this));
        }),
        $(".footerSection .accordianShow a, .storeToInstall a").on(
          "click",
          function () {
            var e = $(this).text().trim().replace(/ /g, "_").toLowerCase(),
              t =
                "footer:" +
                $(this)
                  .parent()
                  ...
                  .toLowerCase(),
              r = $(this).attr("href");
            $(this).parents(".storeToInstall").length > 0 &&
              (e = $(this)
                .find("img")
                .attr("alt")
                .trim()
        ...
        $(".rte-wrap a").off("click"),
        $(".rte-wrap a").on("click", function () {
          if ($(".lap-footer").length > 0) {
            var e = $(this).text().trim().replace(/ /g, "_").toLowerCase(),
              t = "link",
              r = "footer",
              c = $(this).attr("href");
          ...
          } else if ($(this).parents(".rte").hasClass("dividend-datalayer")) {
            (e = $(this).text().trim().replace(/ /g, "_").toLowerCase()),
              (t = "link"),
              (r = $(this)
                .parents(".rte.dividend-datalayer")
                .siblings(".rte.investors-rte")
                .find("h2")
                .text()
                .trim()
                .replace(/ /g, "_")
          ...
          } else if ($(this).parents(".rte").hasClass("terms-and-condition")) {
            (e = $(this).text().trim().replace(/ /g, "_").toLowerCase()),
              (t = "link"),
              (r = $(this)
                .parents(".terms-and-condition")
                .siblings(".product-title-common")
            ...
            $(this).parents(".accordion").hasClass("simple-accordion") ||
            $(this).parents(".accordion").hasClass("product-accordion")
          ) {
            (e = $(this).text().trim().replace(/ /g, "_").toLowerCase()),
              (t = "link"),
              (r = $(this)
                .parents(".cmp-accordion__item")
                .find(".cmp-accordion__title")
                .text()
                .trim()
                .replace(/ /g, "_")
                .toLowerCase()),
        ...
        $(".arrow-cta").on("click", function () {
          var e = $(this).text().trim().replace(/ /g, "_").toLowerCase(),
            t = $(this)
              .closest(".container.responsivegrid")
              .find(".cmp-title__text");
          t.length > 0 ||
          (t = $(this)
            .closest(".container.responsivegrid")
            .parent()
            .closest(".container.responsivegrid")
            .find(".cmp-title__text")).length > 0
            ? ((t = t.text().trim().replace(/ /g, "_").toLowerCase()).includes(
                "faq"
              ) ||
        ...
        $(
          ".footerSection a.needHelpPart, .followUsLinks ul li a, .footerBottom a.backToTop"
        ).on("click", function () {
          let e = $(this).text().trim().replace(/ /g, "_").toLowerCase();
          var t = "footer:social_media",
            r = $(this).attr("href");
          "needHelpPart" == $(this).attr("class")
            ? (t = "footer:support")
            : "backToTop" == $(this).attr("class") && (t = "footer"),
            a("click", n, i, o, l, {
              linkInfo: {
                linkName: e,
                linkType: "link",
